    ...
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700'>
      ...
      >
        <div className='flex items-center gap-3'>
          <Sparkles className='w-6 text-[#d64639]' />
        ...
        <button disabled={loading}
          ...
          className='w-full flex justify-center items-center gap-2 bg-gradient-to-r
           from-[#F6ab41] to-[#ff4938] text-black px-4 py-2 mt-6 text-sm rounded-lg cursor-pointer'>
      ...
      <div className='w-full max-w-lg p-4 bg-white rounded-lg flex flex-col border border-gray-200 min-h-96'>
        <div className='flex items-center gap-3'>
          <Eraser className='w-5 h-5 text-[#d95829]' />
...
export default RemoveBackgrounds;
