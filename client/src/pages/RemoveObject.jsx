    ...
    const onSubmitHandler = async (e) => {
      ...
      try{
         ...
         if(object.split('').length>1){
          return toast('Plese enter only one object')
         }
    ...
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700'>
      <form
        ...
        />
               ...
               <p className='mt-6 text-sm font-medium'>Descrribe object name to remove</p>
        ...
        <button disabled ={loading}
          type='submit'
          className='w-full flex justify-center items-center gap-2 bg-gradient-to-r from-[#2962d5] to-[#643a91] text-black px-4 py-2 mt-6 text-sm rounded-lg cursor-pointer'>
            {
      ...
      <div className='w-full max-w-lg p-4 bg-white rounded-lg flex flex-col border border-gray-200 min-h-96'>
        <div className='flex items-center gap-3'>
          <Scissors className='w-5 h-5 text-[#513de5]' />
