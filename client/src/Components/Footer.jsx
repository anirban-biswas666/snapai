  ...
  return (
   ...
   mt-20">
    <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500/30 pb-6">
        <div className="md:max-w-96">
            ...
            <p className="mt-6 text-sm">
               Experience the power of AI with Snap.ai <br /> Transform your conent creation with our suit of premium Ai tools.
    ...
    <p className="pt-4 text-center text-xs md:text-sm pb-5">
        Copyright 2025 ©Anirban Biswas <a href="https://prebuiltui.com">PrebuiltUI</a>. All Right Reserved.
    </p>
</footer>
  )
}
